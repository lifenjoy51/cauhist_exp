...
links.locales['kr'] = {
    ...
    'MONTHS_SHORT':  new Array("1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"),
    'DAYS': new Array("일요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일"),
    'DAYS_SHORT': new Array("일", "월", "화", "수", "목", "금", "토"),
    'ZOOM_IN': "확대",
    'ZOOM_OUT': "축소",
    'MOVE_LEFT': "왼쪽으로",
    'MOVE_RIGHT': "오른쪽으로",
    'NEW': "추가",
    'CREATE_NEW_EVENT': "새로운 이벤트 추가"
};

links.locales['ko_KR'] = links.locales['kr'];
links.locales['ko_KR'] = links.locales['kr'];
